...
from dipplanner.tools import pressure_to_depth
from dipplanner.tools import calculate_pp_h2o_surf
from dipplanner.tools import convert_bar_to_psi
from dipplanner.tools import convert_cubicfeet_to_liter
from dipplanner.tools import convert_feet_to_meter
...
class SafeEvalTools(TestTools):
    ...
    def test_eval_bad_1(self):
        try:
            _ = safe_eval_calculator("(5+6) * 4 / 3")
        except ValueError:
            pass
        else:
...
class TimeTools(TestTools):
    ...
    def test_seconds_to_mmss_1(self):
        self.assertEqual(seconds_to_mmss(10),
                         "  0:10",
                         "Wrong output for seconds to mmss: %s" %
                         seconds_to_mmss(10))

    def test_seconds_to_mmss_2(self):
        self.assertEqual(seconds_to_mmss(100),
                         "  1:40",
                         "Wrong output for seconds to mmss: %s" %
                         seconds_to_mmss(100))

    def test_seconds_to_mmss_3(self):
        self.assertEqual(seconds_to_mmss(875),
                         " 14:35",
                         "Wrong output for seconds to mmss: %s" %
                         seconds_to_mmss(875))

    def test_seconds_to_mmss_4(self):
        self.assertEqual(seconds_to_mmss(447851),
                         "7464:11",
                         "Wrong output for seconds to mmss: %s" %
...
class TestAltOrDepthToAbsPressure_minus10m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(altitude_or_depth_to_absolute_pressure(-10),
                               2.02368, 5,
                               'Wrong pressure at -10m : %s' %
                               altitude_or_depth_to_absolute_pressure(-10))
...
class TestPressureConverter0m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(altitude_to_pressure(0),
                               1.01325, 5,
                               'Wrong pressure at 0m : %s' %
...
class TestDepthPressure0m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(0),
                               0.0, 5,
...
class TestDepthPressure10m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(10),
                               1.01043, 5,
                               'Wrong depth pressure at 10m : %s' %
                               depth_to_pressure(10))


class TestDepthPressure20m(TestTools):

    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(20),
                               2.02086, 5,
...
class TestDepthPressure30m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(30),
                               3.03129, 5,
...
class TestDepthPressure40m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(40),
                               4.04172, 5,
...
class TestDepthPressure50m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(50),
                               5.05215, 5,
...
class TestDepthPressure60m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(60),
                               6.06258, 5,
...
class TestDepthPressure70m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(70),
                               7.07301, 5,
...
class TestDepthPressure80m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(80),
                               8.08344, 5,
...
class TestDepthPressure90m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(90),
                               9.09387, 5,
...
class TestDepthPressure100m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(100),
                               10.1043, 4,
...
class TestPressureToDeph(TestTools):
    ...
    def test_depth_to_pressure_100(self):
        self.assertAlmostEqual(pressure_to_depth(10.1043), 100, 5,
                               'Wrong depth pressure at 100m : %s' %
                               depth_to_pressure(10.1043))
...
class TestCalculate_ppH2O_surf(TestTools):
    ...
    def test_calculate_pp_h2o_surf_0(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(0.0),
                               0.00651325686767, 7,
                               "Wrong ppH2O surf at 0° : %s" %
                               calculate_pp_h2o_surf(0))
...
class TestConversionsImperialSi(TestTools):
    ...
    def test_convert_bar_to_psi_1(self):
        self.assertAlmostEqual(convert_bar_to_psi(1), 14.5037744, 7,
                               'Wrong conversion:%s' % convert_bar_to_psi(1))

    def test_convert_bar_to_psi_35(self):
        self.assertAlmostEqual(convert_bar_to_psi(35), 507.632104, 7,
                               'Wrong conversion:%s' % convert_bar_to_psi(35))

    def test_convert_bar_to_psi_100(self):
        self.assertAlmostEqual(convert_bar_to_psi(100), 1450.37744, 7,
                               'Wrong conversion:%s' % convert_bar_to_psi(100))

    def test_convert_bar_to_psi_230(self):
        self.assertAlmostEqual(convert_bar_to_psi(230), 3335.868112, 7,
                               'Wrong conversion:%s' % convert_bar_to_psi(230))

    def test_convert_bar_to_psi_300(self):
        self.assertAlmostEqual(convert_bar_to_psi(300), 4351.13232, 7,
                               'Wrong conversion:%s' % convert_bar_to_psi(300))

    def test_convert_psi_to_bar_1(self):
        self.assertAlmostEqual(convert_psi_to_bar(14.5037744), 1, 7,
                               'Wrong conversion:%s' %
                               convert_psi_to_bar(14.5037744))

    def test_convert_psi_to_bar_35(self):
        self.assertAlmostEqual(convert_psi_to_bar(507.632104), 35, 7,
                               'Wrong conversion:%s' %
                               convert_psi_to_bar(507.632104))

    def test_convert_psi_to_bar_100(self):
        self.assertAlmostEqual(convert_psi_to_bar(1450.37744), 100, 7,
                               'Wrong conversion:%s' %
                               convert_psi_to_bar(1450.37744))

    def test_convert_psi_to_bar_230(self):
        self.assertAlmostEqual(convert_psi_to_bar(3335.868112), 230, 7,
                               'Wrong conversion:%s' %
                               convert_psi_to_bar(3335.868112))

    def test_convert_psi_to_bar_300(self):
        self.assertAlmostEqual(convert_psi_to_bar(4351.13232), 300, 7,
                               'Wrong conversion:%s' %
                               convert_psi_to_bar(4351.13232))

    def test_convert_liter_to_cubicfeet_1(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(1),
                               0.0353146667215, 7,
                               'Wrong conversion:%s' %
                               convert_liter_to_cubicfeet(1))

    def test_convert_liter_to_cubicfeet_6(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(6),
                               0.211888000329, 7,
                               'Wrong conversion:%s' %
                               convert_liter_to_cubicfeet(6))

    def test_convert_liter_to_cubicfeet_12(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(12),
                               0.423776000658, 7,
                               'Wrong conversion:%s' %
                               convert_liter_to_cubicfeet(12))

    def test_convert_liter_to_cubicfeet_15(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(15),
                               0.529720000822, 7,
                               'Wrong conversion:%s' %
                               convert_liter_to_cubicfeet(15))

    def test_convert_liter_to_cubicfeet_18(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(18),
                               0.635664000987, 7,
                               'Wrong conversion:%s' %
                               convert_liter_to_cubicfeet(18))

    def test_convert_cubicfeet_to_liter_1(self):
        self.assertAlmostEqual(convert_cubicfeet_to_liter(0.0353146667215),
                               1, 7,
                               'Wrong conversion:%s' %
                               convert_cubicfeet_to_liter(0.0353146667215))

    def test_convert_cubicfeet_to_liter_6(self):
        self.assertAlmostEqual(convert_cubicfeet_to_liter(0.211888000329),
                               6, 7,
                               'Wrong conversion:%s' %
                               convert_cubicfeet_to_liter(0.211888000329))

    def test_convert_cubicfeet_to_liter_12(self):
        self.assertAlmostEqual(convert_cubicfeet_to_liter(0.423776000658),
                               12, 7,
                               'Wrong conversion:%s' %
                               convert_cubicfeet_to_liter(0.423776000658))

    def test_convert_cubicfeet_to_liter_15(self):
        self.assertAlmostEqual(convert_cubicfeet_to_liter(0.529720000822),
                               15, 7,
                               'Wrong conversion:%s' %
                               convert_cubicfeet_to_liter(0.529720000822))

    def test_convert_cubicfeet_to_liter_18(self):
        self.assertAlmostEqual(convert_cubicfeet_to_liter(0.635664000987),
                               18, 7,
                               'Wrong conversion:%s' %
                               convert_cubicfeet_to_liter(0.635664000987))

    def test_convert_meter_to_feet_1(self):
        self.assertAlmostEqual(convert_meter_to_feet(1), 3.28083989501,
                               7,
                               'Wrong conversion:%s' %
                               convert_meter_to_feet(1))

    def test_convert_meter_to_feet_15(self):
        self.assertAlmostEqual(convert_meter_to_feet(15),
                               49.2125984252, 7,
                               'Wrong conversion:%s' %
                               convert_meter_to_feet(15))

    def test_convert_meter_to_feet_30(self):
        self.assertAlmostEqual(convert_meter_to_feet(30),
                               98.4251968504, 7,
                               'Wrong conversion:%s' %
                               convert_meter_to_feet(30))

    def test_convert_meter_to_feet_50(self):
        self.assertAlmostEqual(convert_meter_to_feet(50),
                               164.041994751, 7,
                               'Wrong conversion:%s' %
                               convert_meter_to_feet(50))

    def test_convert_meter_to_feet_70(self):
        self.assertAlmostEqual(convert_meter_to_feet(70),
                               229.658792651, 7,
                               'Wrong conversion:%s' %
                               convert_meter_to_feet(70))

    def test_convert_feet_to_meter_1(self):
        self.assertAlmostEqual(convert_feet_to_meter(3.28083989501), 1,
                               7,
                               'Wrong conversion:%s' %
                               convert_feet_to_meter(3.28083989501))

    def test_convert_feet_to_meter_15(self):
        self.assertAlmostEqual(convert_feet_to_meter(49.2125984252),
                               15, 7,
                               'Wrong conversion:%s' %
                               convert_feet_to_meter(49.2125984252))

    def test_convert_feet_to_meter_30(self):
        self.assertAlmostEqual(convert_feet_to_meter(98.4251968504),
                               30, 7,
                               'Wrong conversion:%s' %
                               convert_feet_to_meter(98.4251968504))

    def test_convert_feet_to_meter_50(self):
        self.assertAlmostEqual(convert_feet_to_meter(164.041994751),
                               50, 7,
                               'Wrong conversion:%s' %
                               convert_feet_to_meter(164.041994751))

    def test_convert_feet_to_meter_70(self):
        self.assertAlmostEqual(convert_feet_to_meter(229.658792651),
                               70, 7,
                               'Wrong conversion:%s' %
                               convert_feet_to_meter(229.658792651))
