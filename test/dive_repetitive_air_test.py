...
class TestRepetitiveDive1(TestDive):
    ...
    def setUp(self):
        ...
        self.profile0 = Dive(self.mission, [diveseg1], [self.airtank12])
        self.profile0.do_dive()

        diveseg2 = SegmentDive(40, 20 * 60, self.airtank, 0)
        self.profile1 = Dive(self.mission, [diveseg2], [self.airtank], self.profile0)
...
class TestRepetitiveDive2(TestDive):
    ...
    def setUp(self):
        ...
        self.profile2 = Dive(self.mission, [diveseg3], [self.airtank], self.profile1)
...
class TestRepetitiveDive3(TestDive):
    ...
    def setUp(self):
        ...
        self.profile3 = Dive(self.mission, [diveseg4], [self.airtank], self.profile2)
