...
class TestModelBuhlmannModelOutput1(TestModelBuhlmannModel):
    def runTest(self):
        self.assertEqual(str(self.model1),
                         """C:0 He:0.0 N2:0.789444359701 gf:0.3 mv_at:2.98611129437 max_amb:0.354301769605 MV:0.264372048419
...
class TestModelBuhlmannModelOutput2(TestModelBuhlmannModel):
    def runTest(self):
        self.assertEqual(str(self.model2),
                         """C:0 He:0.0 N2:19.9991340314 gf:0.3 mv_at:2.98611129437 max_amb:15.8731803417 MV:6.6973840088
