...
class TestAltOrDepthToAbsPressure_minus10m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(altitude_or_depth_to_absolute_pressure(-10),
                               2.02368, 5, 'Wrong pressure at -10m : %s'
...
class TestDepthPressure10m(TestTools):
    ...
    def runTest(self):
        self.assertAlmostEqual(depth_to_pressure(10), 1.01043, 5,
...
class TestConversionsImperialSi(TestTools):
    ...
    def test_convert_liter_to_cubicfeet_1(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(1),
                               0.0353146667215, 7, 'Wrong conversion:%s'
    ...
    def test_convert_liter_to_cubicfeet_6(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(6),
                               0.211888000329, 7, 'Wrong conversion:%s'
    ...
    def test_convert_liter_to_cubicfeet_12(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(12),
                               0.423776000658, 7, 'Wrong conversion:%s'
    ...
    def test_convert_liter_to_cubicfeet_15(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(15),
                               0.529720000822, 7, 'Wrong conversion:%s'
    ...
    def test_convert_liter_to_cubicfeet_18(self):
        self.assertAlmostEqual(convert_liter_to_cubicfeet(18),
                               0.635664000987, 7, 'Wrong conversion:%s'
