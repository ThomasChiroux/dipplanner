...
class TestDiveAir10m20min(TestDive):
    ...
    def test_no_flight(self):
        no_flight_time = self.profile1.no_flight_time()
        self.assertEqual(no_flight_time, 1140, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveAir10m30min(TestDive):
    ...
    def test_no_flight(self):
        no_flight_time = self.profile1.no_flight_time()
        self.assertEqual(no_flight_time, 0, "Bad no flight time: %s" % no_flight_time) #TODO: STRANGE VALUE..
...
class TestDiveAir20m30min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 32:04", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveAir20m40min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 46:22", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
    ...
    def test_no_flight(self):
        no_flight_time = self.profile1.no_flight_time()
        self.assertEqual(no_flight_time, 1440, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveAir30m20min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 27:24", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
    ...
    def test_no_flight(self):
        no_flight_time = self.profile1.no_flight_time()
        self.assertEqual(no_flight_time, 780, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveAir30m40min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 76:39", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
    ...
    def test_no_flight(self):
        no_flight_time = self.profile1.no_flight_time()
        self.assertEqual(no_flight_time, 3240, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveAir40m10min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 14:26", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveAir40m20min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 38:36", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveAir50m10min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 18:07", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveAir50m20min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 55:23", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveAir50m30min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == "110:53", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveAir60m10min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 22:04", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveAir60m20min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == " 73:53", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
    ...
    def test_no_flight(self):
        no_flight_time = self.profile1.no_flight_time()
        self.assertEqual(no_flight_time, 3480, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveAir60m25min(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == "112:57", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
    ...
    def test_no_flight(self):
        no_flight_time = self.profile1.no_flight_time()
        self.assertEqual(no_flight_time, 7620, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveMultilevel(TestDive):
    ...
    def test_RT(self):
        assert seconds_to_mmss(self.profile1.run_time) == "101:31", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)

    def test_OTU(self):
        self.assertAlmostEqual(self.profile1.model.ox_tox.otu, 37.8141251462, 7, "bad dive OTU ? (%s)" % self.profile1.model.ox_tox.otu)

    def test_CNS(self):
        self.assertAlmostEqual(self.profile1.model.ox_tox.cns * 100, 14.8265932326, 7, "bad dive CNS ? (%s)" % (self.profile1.model.ox_tox.cns * 100))

    def test_tank_cons(self):
        self.assertAlmostEqual(self.airdouble.used_gas, 4529.0077587, 7, "bad used gas (%s)" % self.airdouble.used_gas)
    ...
    def test_no_flight(self):
        no_flight_time = self.profile1.no_flight_time()
        self.assertEqual(no_flight_time, 5400, "Bad no flight time: %s" % no_flight_time)
