...
class TestDiveTxHypo50m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 26:14", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    ...
    self.assertEqual(no_flight_time, 1080, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo50m20min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 61:08", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 4260, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo50m30min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "102:53", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 8160, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo50m40min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "149:55", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 13440, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo60m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 33:41", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 1560, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo60m20min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 80:02", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 6060, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo60m30min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "134:23", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 12360, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo70m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 42:32", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 2280, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo70m20min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "100:20", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 8220, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo80m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 51:32", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 3000, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo80m20min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "124:26", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 11460, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo90m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 61:09", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveTxHypo90m20min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "152:01", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 14400, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo100m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 73:30", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 5580, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo100m15min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "124:32", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 11520, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo110m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 86:21", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 6600, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo110m15min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "145:21", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 13860, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo120m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "100:31", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveTxHypo130m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "116:48", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 10380, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveTxHypo140m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "133:59", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
...
class TestDiveTxHypo150m10min(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == "155:22", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 14700, "Bad no flight time: %s" % no_flight_time)
...
class TestDiveMultilevel(TestDive):
  ...
  def test_RT(self):
    assert seconds_to_mmss(self.profile1.run_time) == " 94:53", "bad dive runtime ? (%s)" % seconds_to_mmss(self.profile1.run_time)
  ...
  def test_no_flight(self):
    no_flight_time = self.profile1.no_flight_time()
    self.assertEqual(no_flight_time, 6720, "Bad no flight time: %s" % no_flight_time)
