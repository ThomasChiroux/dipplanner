...
class TestCalculate_ppH2O_surf(TestTools):
    ...
    def test_calculate_pp_h2o_surf_moins10(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(-10.0), 0.00651325686767, 7, "Wrong ppH2O surf at -10° : %s" % calculate_pp_h2o_surf(-10))

    def test_calculate_pp_h2o_surf_0(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(0.0), 0.00651325686767, 7, "Wrong ppH2O surf at 0° : %s" % calculate_pp_h2o_surf(0))

    def test_calculate_pp_h2o_surf_1(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(1), 0.00651325686767, 7, "Wrong ppH2O surf at 1° : %s" % calculate_pp_h2o_surf(1))

    def test_calculate_pp_h2o_surf_5(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(5), 0.00866264906268, 7, "Wrong ppH2O surf at 5° : %s" % calculate_pp_h2o_surf(5))

    def test_calculate_pp_h2o_surf_10(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(10), 0.0122107541129, 7, "Wrong ppH2O surf at 10° : %s" % calculate_pp_h2o_surf(10))

    def test_calculate_pp_h2o_surf_15(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(15), 0.0169758994956, 7, "Wrong ppH2O surf at 15° : %s" % calculate_pp_h2o_surf(15))

    def test_calculate_pp_h2o_surf_20(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(20), 0.0232957591939, 7, "Wrong ppH2O surf at 20° : %s" % calculate_pp_h2o_surf(20))

    def test_calculate_pp_h2o_surf_25(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(25), 0.0315792952353, 7, "Wrong ppH2O surf at 25° : %s" % calculate_pp_h2o_surf(25))

    def test_calculate_pp_h2o_surf_30(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(30), 0.0423167530545, 7, "Wrong ppH2O surf at 30° : %s" % calculate_pp_h2o_surf(30))

    def test_calculate_pp_h2o_surf_35(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(35), 0.0560901835181, 7, "Wrong ppH2O surf at 35° : %s" % calculate_pp_h2o_surf(35))

    def test_calculate_pp_h2o_surf_40(self):
        self.assertAlmostEqual(calculate_pp_h2o_surf(40), 0.0735844054898, 7, "Wrong ppH2O surf at 40° : %s" % calculate_pp_h2o_surf(40))
